...
`src/config.js` 의 팩 구성은 **웹 가격을 그대로 옮겨둔 자리표시자**다.
정산율이 79.5%라 웹(약 99%) 기준 구성을 그대로 쓰면 곡당 순이익이 810원 → 617원이
되고, 앱마켓 수수료가 30%로 오르면 469원이다. ₩9,900=15곡 팩은 그 경우 355원까지
떨어진다. **콘솔에 상품을 등록하기 전에 미니앱 전용 구성을 다시 잡을 것.**
